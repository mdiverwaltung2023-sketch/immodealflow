  ...
  return (
    <Card title={`Bewertung für ${targetLabel} abgeben`}>
      <form onSubmit={submit} className="space-y-4">
        <div>
          <div className="mb-2 text-xs uppercase tracking-wide text-zinc-500">Sterne</div>
          <StarPicker value={stars} onChange={setStars} disabled={busy} />
        </div>

        <div>
          <div className="mb-2 text-xs uppercase tracking-wide text-zinc-500">Beschreibung</div>
          <textarea
            value={body}
