...
import { MeSchema, type UserRoleT } from "@/lib/api";
 ...
 * übergibt die Rolle an SideNav + TopBar.
 *
 * Falls /me 401/Fehler liefert (z. B. Token kurz weg), fallen wir auf
 * Rolle "BOTH" zurück — dann sieht der User alles, und der nächste Klick
 * führt ihn ggf. ins Onboarding.
 */
