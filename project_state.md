...
| Datum       | Inhalt                                                       |
|-------------|--------------------------------------------------------------|
| 2026-06-21  | Phase Q1 (Co-Investment Hub): NEUE Tabelle CoInvestRequest + Enums InvestStrategy/CoInvestStatus (Migration 20260621120000_coinvest_requests) + Matching-Engine lib/coinvest.ts (6-Faktor-Score: Region/Objektart/Volumen/Strategie/Rendite/Erfahrung, mit Breakdown) + Endpunkte (/me/coinvest-requests CRUD, /me/coinvest-requests/:id/matches, /coinvest/marketplace, /coinvest/feed) + Frontend /co-investments (Gesuch anlegen/veroeffentlichen, Marktplatz, personalisierter Feed, Match-Detail) + SideNav-Eintrag. Baut additiv auf InvestorProfile (Kapitalseite) auf. Reine Kontaktvermittlung, KEIN Crowdfunding, KEIN Erfolgshonorar. **Migration laeuft via prisma migrate deploy beim Railway-Start.** |
